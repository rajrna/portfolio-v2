...
export default function PortfolioSection() {
  return (
    <section className="flex flex-col justify-center h-full pl-64 font-mono text-platinum">
      <div className="mt-15">
        <div className="mb-4 text-off-red text-left text-2xl ">Hey, I am</div>
        <h1 className="text-5xl font-bold mb-4 text-left  text-platinum">
          Raj Rana<span className="text-off-red">.</span>
        </h1>
        <p className="mb-6 text-left text-2xl  text-platinum">
      ...
      <div className="mb-8">
        <button className="mt-2 px-6 py-2 border border-off-red text-platinum rounded hover:bg-off-red-500 hover:text-black  transition">
          Contact
        </button>
      </div>
      ...
      <br />
      <div className="mb-8">
        <h2 className="text-3xl font-semibold mb-4 text-off-red">
          Skills & Technologies
        </h2>
      ...
      {/* Work Experience */}
      <h3 className="text-2xl font-bold text-off-red mb-4 font-mono">
        Work Experience
      </h3>
      <div className="flex flex-col gap-8 font-mono">
        <div>
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            <span className="font-semibold text-lg text-platinum">
              Backend Intern
            </span>
          ...
          <ul className="list-disc pl-6 mt-2 text-platinum text-base leading-relaxed">
            <li>
